...
// runGenerateCheck is `provider generate -check`: build the fileset the
// blueprints produce, compare it against the committed tree, and fail on drift
// without writing anything.
func runGenerateCheck(o generateOptions) error {
	blueprintPath, out, summaryPath := &o.blueprintPath, &o.out, &o.summary
