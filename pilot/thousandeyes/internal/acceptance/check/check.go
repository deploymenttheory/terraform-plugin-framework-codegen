...
// reads as a sentence and, more usefully, groups by resource so the generator emits the address
...
import (
	...
	"github.com/deploymenttheory/terraform-plugin-framework-codegen/pilot/thousandeyes/internal/acceptance/types"
)
