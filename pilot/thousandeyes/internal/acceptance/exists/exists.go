...
// belong in the test's own Check functions where a reader can see them.
type ReadFunc func(ctx context.Context, client *te.Client, state *terraform.InstanceState) error
