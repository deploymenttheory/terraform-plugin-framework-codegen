...
func (r *TestsDNSServerResource) readState(
	...
	remote, _, err := r.client.API.DNSServerTests.GetDnsServerTest(ctx, state.TestID.ValueString())
	if err != nil {
...
func (r *TestsDNSServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.DNSServerTests.UpdateDnsServerTest(ctx, state.TestID.ValueString(), body)
	if err != nil {
...
func (r *TestsDNSServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.DNSServerTests.DeleteDnsServerTest(ctx, state.TestID.ValueString())
	if err != nil {
