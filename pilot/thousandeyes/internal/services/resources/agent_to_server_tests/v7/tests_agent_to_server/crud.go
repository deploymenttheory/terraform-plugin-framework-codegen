...
func (r *TestsAgentToServerResource) readState(
	...
	remote, _, err := r.client.API.AgentToServerTests.GetAgentToServerTest(ctx, state.TestID.ValueString())
	if err != nil {
...
func (r *TestsAgentToServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.AgentToServerTests.DeleteAgentToServerTest(ctx, state.TestID.ValueString())
	if err != nil {
