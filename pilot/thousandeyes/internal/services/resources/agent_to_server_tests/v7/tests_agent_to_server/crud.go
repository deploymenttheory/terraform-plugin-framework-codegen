...
func (r *TestsAgentToServerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, _, err := r.client.API.AgentToServerTests.CreateAgentToServerTest(ctx, body)
	if err != nil {
...
func (r *TestsAgentToServerResource) readState(
	...
	remote, _, err := r.client.API.AgentToServerTests.GetAgentToServerTest(ctx, state.ID.ValueString())
	if err != nil {
...
func (r *TestsAgentToServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.AgentToServerTests.DeleteAgentToServerTest(ctx, state.ID.ValueString())
	if err != nil {
