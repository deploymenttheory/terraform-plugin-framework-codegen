...
func (r *DashboardResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, _, err := r.client.API.Dashboards.CreateDashboard(ctx, body)
	if err != nil {
	...
	// record of.
	plan.ID = convert.PtrStringToFramework(created.DashboardID)
...
func (r *DashboardResource) readState(
	...
	remote, _, err := r.client.API.Dashboards.GetDashboard(ctx, state.ID.ValueString())
	if err != nil {
...
func (r *DashboardResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.Dashboards.UpdateDashboard(ctx, state.ID.ValueString(), body)
	if err != nil {
...
func (r *DashboardResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.Dashboards.DeleteDashboard(ctx, state.ID.ValueString())
	if err != nil {
