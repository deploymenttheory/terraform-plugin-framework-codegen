...
func (r *TestsDnssecResource) readState(
	...
	remote, _, err := r.client.API.DNSSECTests.GetDnsSecTest(ctx, state.TestID.ValueString())
	if err != nil {
...
func (r *TestsDnssecResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.DNSSECTests.UpdateDnsSecTest(ctx, state.TestID.ValueString(), body)
	if err != nil {
...
func (r *TestsDnssecResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.DNSSECTests.DeleteDnsSecTest(ctx, state.TestID.ValueString())
	if err != nil {
