...
import (
	...
	"github.com/deploymenttheory/terraform-plugin-framework-codegen/pilot/thousandeyes/internal/services/resources/dns_trace_tests/v7/tests_dns_trace"
)
		...
		Steps: []resource.TestStep{
			// Create, from the smallest configuration the schema permits.
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					check.That(address).Key("domain").Exists(),
			...
			// is the most common way a generated provider is subtly wrong.
			{
				...
				// agents: the API never returns it, so it is absent after an import
