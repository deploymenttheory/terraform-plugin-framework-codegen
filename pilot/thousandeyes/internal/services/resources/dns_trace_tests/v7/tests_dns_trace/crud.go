...
func (r *TestsDNSTraceResource) readState(
	...
	remote, _, err := r.client.API.DNSTraceTests.GetDnsTraceTest(ctx, state.TestID.ValueString())
	if err != nil {
...
func (r *TestsDNSTraceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.DNSTraceTests.UpdateDnsTraceTest(ctx, state.TestID.ValueString(), body)
	if err != nil {
...
func (r *TestsDNSTraceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.DNSTraceTests.DeleteDnsTraceTest(ctx, state.TestID.ValueString())
	if err != nil {
