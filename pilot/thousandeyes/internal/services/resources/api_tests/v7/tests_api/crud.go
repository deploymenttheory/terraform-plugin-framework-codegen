...
func (r *TestsAPIResource) readState(
	...
	remote, _, err := r.client.API.APITests.GetApiTest(ctx, state.TestID.ValueString())
	if err != nil {
...
func (r *TestsAPIResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.APITests.UpdateApiTest(ctx, state.TestID.ValueString(), body)
	if err != nil {
...
func (r *TestsAPIResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.APITests.DeleteApiTest(ctx, state.TestID.ValueString())
	if err != nil {
