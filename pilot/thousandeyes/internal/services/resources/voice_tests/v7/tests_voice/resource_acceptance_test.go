...
import (
	...
	"github.com/deploymenttheory/terraform-plugin-framework-codegen/pilot/thousandeyes/internal/services/resources/voice_tests/v7/tests_voice"
)

// The resource under test, and the helper that asks the API whether it is really there.
const address = "thousandeyes_tests_voice.test"

var testResource = tests_voice.TestsVoiceTestResource{}

// TestAccResourceTestsVoice_01_Lifecycle exercises the whole lifecycle against a live API.
//
...
func TestAccResourceTestsVoice_01_Lifecycle(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: destroy.CheckDestroyed(testResource, "thousandeyes_tests_voice", 20*time.Second),
