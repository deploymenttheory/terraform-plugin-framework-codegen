...
func (r *TestsVoiceResource) readState(
	...
	remote, _, err := r.client.API.VoiceTests.GetVoiceTest(ctx, state.TestID.ValueString())
	if err != nil {
...
func (r *TestsVoiceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.VoiceTests.UpdateVoiceTest(ctx, state.TestID.ValueString(), body)
	if err != nil {
...
func (r *TestsVoiceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.VoiceTests.DeleteVoiceTest(ctx, state.TestID.ValueString())
	if err != nil {
