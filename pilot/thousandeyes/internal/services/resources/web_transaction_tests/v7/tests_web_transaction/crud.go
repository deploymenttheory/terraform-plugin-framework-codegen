...
func (r *TestsWebTransactionResource) readState(
	...
	remote, _, err := r.client.API.WebTransactionTests.GetWebTransactionsTest(ctx, state.TestID.ValueString())
	if err != nil {
...
func (r *TestsWebTransactionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.WebTransactionTests.UpdateWebTransactionsTest(ctx, state.TestID.ValueString(), body)
	if err != nil {
...
func (r *TestsWebTransactionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.WebTransactionTests.DeleteWebTransactionsTest(ctx, state.TestID.ValueString())
	if err != nil {
