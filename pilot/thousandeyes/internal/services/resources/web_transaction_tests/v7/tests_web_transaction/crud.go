...
func (r *TestsWebTransactionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, _, err := r.client.API.WebTransactionTests.CreateWebTransactionsTest(ctx, body)
	if err != nil {
...
func (r *TestsWebTransactionResource) readState(
	...
	remote, _, err := r.client.API.WebTransactionTests.GetWebTransactionsTest(ctx, state.ID.ValueString())
	if err != nil {
...
func (r *TestsWebTransactionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.WebTransactionTests.UpdateWebTransactionsTest(ctx, state.ID.ValueString(), body)
	if err != nil {
...
func (r *TestsWebTransactionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.WebTransactionTests.DeleteWebTransactionsTest(ctx, state.ID.ValueString())
	if err != nil {
