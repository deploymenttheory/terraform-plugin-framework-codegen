...
import (
	...
	teclient "github.com/deploymenttheory/go-sdk-thousandeyes/thousandeyes/client"
...
func (r *EndpointLabelResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, _, err := r.client.API.EndpointAgentLabels.CreateEndpointLabel(ctx, body)
	if err != nil {
	...
	// record of.
	plan.ID = convert.EnumToFramework[endpoint_agent_labels.LabelId](created.ID)
...
func (r *EndpointLabelResource) readState(
	...
	remote, _, err := r.client.API.EndpointAgentLabels.GetEndpointLabel(ctx, state.ID.ValueString(), teclient.WithQueryParam("expand", "filters"))
	if err != nil {
...
func (r *EndpointLabelResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.EndpointAgentLabels.UpdateEndpointLabel(ctx, state.ID.ValueString(), body)
	if err != nil {
...
func (r *EndpointLabelResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.EndpointAgentLabels.DeleteEndpointLabel(ctx, state.ID.ValueString())
	if err != nil {
