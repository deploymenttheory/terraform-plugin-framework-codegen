...
func (r *TestsPageLoadResource) readState(
	...
	remote, _, err := r.client.API.PageLoadTests.GetPageLoadTest(ctx, state.TestID.ValueString())
	if err != nil {
...
func (r *TestsPageLoadResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.PageLoadTests.UpdatePageLoadTest(ctx, state.TestID.ValueString(), body)
	if err != nil {
...
func (r *TestsPageLoadResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.PageLoadTests.DeletePageLoadTest(ctx, state.TestID.ValueString())
	if err != nil {
