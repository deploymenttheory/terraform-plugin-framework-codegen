...
import (
	...
	"github.com/deploymenttheory/terraform-plugin-framework-codegen/pilot/thousandeyes/internal/services/resources/dashboards_filters/v7/dashboards_filter"
)

// The resource under test, and the helper that asks the API whether it is really there.
const address = "thousandeyes_dashboards_filter.test"

var testResource = dashboards_filter.DashboardsFilterTestResource{}

// TestAccResourceDashboardsFilter_01_Lifecycle exercises the whole lifecycle against a live API.
//
...
func TestAccResourceDashboardsFilter_01_Lifecycle(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: destroy.CheckDestroyed(testResource, "thousandeyes_dashboards_filter", 20*time.Second),
