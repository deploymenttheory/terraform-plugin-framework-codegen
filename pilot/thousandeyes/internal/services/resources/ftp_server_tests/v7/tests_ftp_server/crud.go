...
func (r *TestsFTPServerResource) readState(
	...
	remote, _, err := r.client.API.FTPServerTests.GetFtpServerTest(ctx, state.TestID.ValueString())
	if err != nil {
...
func (r *TestsFTPServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.FTPServerTests.UpdateFtpServerTest(ctx, state.TestID.ValueString(), body)
	if err != nil {
...
func (r *TestsFTPServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.FTPServerTests.DeleteFtpServerTest(ctx, state.TestID.ValueString())
	if err != nil {
