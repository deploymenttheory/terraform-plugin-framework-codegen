...
import (
	...
	"github.com/deploymenttheory/terraform-plugin-framework-codegen/pilot/thousandeyes/internal/services/resources/ftp_server_tests/v7/tests_ftp_server"
)
		...
		Steps: []resource.TestStep{
			...
			// Update in place, to a configuration that sets the optional attributes too.
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					check.That(address).Key("ftp_time_limit").HasValue("10"),
					...
					check.That(address).Key("url").HasValue("tfacc-url"),
					check.That(address).Key("use_active_ftp").HasValue("true"),
					check.That(address).Key("use_explicit_ftps").HasValue("true"),
