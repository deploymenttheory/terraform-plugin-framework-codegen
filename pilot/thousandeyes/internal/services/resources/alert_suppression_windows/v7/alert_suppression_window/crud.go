...
func (r *AlertSuppressionWindowResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, _, err := r.client.API.AlertSuppressionWindows.CreateAlertSuppressionWindow(ctx, body)
	if err != nil {
	...
	// record of.
	plan.ID = convert.PtrStringToFramework(created.AlertSuppressionWindowID)
...
func (r *AlertSuppressionWindowResource) readState(
	...
	remote, _, err := r.client.API.AlertSuppressionWindows.GetAlertSuppressionWindow(ctx, state.ID.ValueString())
	if err != nil {
...
func (r *AlertSuppressionWindowResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.AlertSuppressionWindows.UpdateAlertSuppressionWindow(ctx, state.ID.ValueString(), body)
	if err != nil {
...
func (r *AlertSuppressionWindowResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.AlertSuppressionWindows.DeleteAlertSuppressionWindow(ctx, state.ID.ValueString())
	if err != nil {
