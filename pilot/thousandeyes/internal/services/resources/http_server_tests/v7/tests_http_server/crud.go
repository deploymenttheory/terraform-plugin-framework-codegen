...
func (r *TestsHTTPServerResource) readState(
	...
	remote, _, err := r.client.API.HTTPServerTests.GetHttpServerTest(ctx, state.TestID.ValueString())
	if err != nil {
...
func (r *TestsHTTPServerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.HTTPServerTests.UpdateHttpServerTest(ctx, state.TestID.ValueString(), body)
	if err != nil {
...
func (r *TestsHTTPServerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.HTTPServerTests.DeleteHttpServerTest(ctx, state.TestID.ValueString())
	if err != nil {
