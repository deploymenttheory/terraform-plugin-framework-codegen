...
func (r *AlertRuleResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, _, err := r.client.API.AlertRules.CreateAlertRule(ctx, body)
	if err != nil {
	...
	// record of.
	plan.ID = convert.EnumToFramework[alert_rules.RuleId](created.RuleID)
...
func (r *AlertRuleResource) readState(
	...
	remote, _, err := r.client.API.AlertRules.GetAlertRule(ctx, state.ID.ValueString())
	if err != nil {
...
func (r *AlertRuleResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, _, err := r.client.API.AlertRules.UpdateAlertRule(ctx, state.ID.ValueString(), body)
	if err != nil {
...
func (r *AlertRuleResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	_, err := r.client.API.AlertRules.DeleteAlertRule(ctx, state.ID.ValueString())
	if err != nil {
