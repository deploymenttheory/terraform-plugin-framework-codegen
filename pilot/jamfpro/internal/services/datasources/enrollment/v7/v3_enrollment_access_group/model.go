...
// V3EnrollmentAccessGroupDataSourceModel is the Terraform state for a jamfpro_v3_enrollment_access_group.
//
// Field order follows the schema, and the timeouts value is last.
type V3EnrollmentAccessGroupDataSourceModel struct {
