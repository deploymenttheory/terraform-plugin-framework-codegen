...
// V1CategoryTestResource answers whether a jamfpro_v1_category is really in the API.
//
...
type V1CategoryTestResource struct{}
...
func (V1CategoryTestResource) Exists(
	ctx context.Context,
	...
	return exists.Check(ctx, state, func(
		...
		_, err := client.V1().Categories().ById(state.ID).Get(ctx, nil)
