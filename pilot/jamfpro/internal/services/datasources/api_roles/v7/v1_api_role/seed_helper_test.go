...
// V1APIRoleTestResource answers whether a jamfpro_v1_api_role is really in the API.
//
...
type V1APIRoleTestResource struct{}
...
func (V1APIRoleTestResource) Exists(
	ctx context.Context,
	...
	return exists.Check(ctx, state, func(
		...
		_, err := client.V1().ApiRoles().ById(state.ID).Get(ctx, nil)
