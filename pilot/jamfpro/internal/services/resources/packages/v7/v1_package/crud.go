...
// Create provisions a new jamfpro_v1_package.
func (r *V1PackageResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1PackageResourceModel
	...
	created, err := r.client.V1().Packages().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_package state from the API.
func (r *V1PackageResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1PackageResourceModel
...
// readState fetches jamfpro_v1_package and maps it onto state.
//
...
func (r *V1PackageResource) readState(
	ctx context.Context,
	state *V1PackageResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().Packages().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1PackageResource) readAfterWrite(
	ctx context.Context,
	state *V1PackageResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_package.
func (r *V1PackageResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1PackageResourceModel
	...
	_, err := r.client.V1().Packages().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_package.
func (r *V1PackageResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1PackageResourceModel
	...
	err := r.client.V1().Packages().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
