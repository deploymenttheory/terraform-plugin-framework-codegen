...
// V1PackageTestResource answers whether a jamfpro_v1_package is really in the API.
//
...
type V1PackageTestResource struct{}
...
func (V1PackageTestResource) Exists(
	ctx context.Context,
	...
	return exists.Check(ctx, state, func(
		...
		_, err := client.V1().Packages().ById(state.ID).Get(ctx, nil)
