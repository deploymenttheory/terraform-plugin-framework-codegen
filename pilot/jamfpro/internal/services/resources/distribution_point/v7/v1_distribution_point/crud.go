...
// Create provisions a new jamfpro_v1_distribution_point.
func (r *V1DistributionPointResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1DistributionPointResourceModel
	...
	created, err := r.client.V1().DistributionPoints().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_distribution_point state from the API.
func (r *V1DistributionPointResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1DistributionPointResourceModel
...
// readState fetches jamfpro_v1_distribution_point and maps it onto state.
//
...
func (r *V1DistributionPointResource) readState(
	ctx context.Context,
	state *V1DistributionPointResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().DistributionPoints().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1DistributionPointResource) readAfterWrite(
	ctx context.Context,
	state *V1DistributionPointResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_distribution_point.
func (r *V1DistributionPointResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1DistributionPointResourceModel
	...
	_, err := r.client.V1().DistributionPoints().ById(state.ID.ValueString()).Patch(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_distribution_point.
func (r *V1DistributionPointResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1DistributionPointResourceModel
	...
	err := r.client.V1().DistributionPoints().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
