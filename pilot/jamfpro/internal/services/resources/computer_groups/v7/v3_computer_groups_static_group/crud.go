...
// Create provisions a new jamfpro_v3_computer_groups_static_group.
func (r *V3ComputerGroupsStaticGroupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V3ComputerGroupsStaticGroupResourceModel
	...
	created, err := r.client.V3().ComputerGroups().StaticGroups().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v3_computer_groups_static_group state from the API.
func (r *V3ComputerGroupsStaticGroupResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V3ComputerGroupsStaticGroupResourceModel
...
// readState fetches jamfpro_v3_computer_groups_static_group and maps it onto state.
//
...
func (r *V3ComputerGroupsStaticGroupResource) readState(
	ctx context.Context,
	state *V3ComputerGroupsStaticGroupResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V3().ComputerGroups().StaticGroups().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V3ComputerGroupsStaticGroupResource) readAfterWrite(
	ctx context.Context,
	state *V3ComputerGroupsStaticGroupResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v3_computer_groups_static_group.
func (r *V3ComputerGroupsStaticGroupResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V3ComputerGroupsStaticGroupResourceModel
	...
	_, err := r.client.V3().ComputerGroups().StaticGroups().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v3_computer_groups_static_group.
func (r *V3ComputerGroupsStaticGroupResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V3ComputerGroupsStaticGroupResourceModel
	...
	err := r.client.V3().ComputerGroups().StaticGroups().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
