...
import (
	...
	"github.com/deploymenttheory/terraform-plugin-framework-codegen/pilot/jamfpro/internal/services/resources/computer_groups/v7/v3_computer_groups_static_group"
)

// The resource under test, and the helper that asks the API whether it is really there.
const address = "jamfpro_v3_computer_groups_static_group.test"

var testResource = v3_computer_groups_static_group.V3ComputerGroupsStaticGroupTestResource{}

// TestAccResourceV3ComputerGroupsStaticGroup_01_Lifecycle exercises the whole lifecycle against a live API.
//
...
func TestAccResourceV3ComputerGroupsStaticGroup_01_Lifecycle(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: destroy.CheckDestroyed(testResource, "jamfpro_v3_computer_groups_static_group", 20*time.Second),
