...
package v2_computer_groups_smart_group_test
...
import (
	...
	"github.com/deploymenttheory/terraform-plugin-framework-codegen/pilot/jamfpro/internal/services/resources/computer_groups/v7/v2_computer_groups_smart_group"
)

// The resource under test, and the helper that asks the API whether it is really there.
const address = "jamfpro_v2_computer_groups_smart_group.test"

var testResource = v2_computer_groups_smart_group.V2ComputerGroupsSmartGroupTestResource{}

// TestAccResourceV2ComputerGroupsSmartGroup_01_Lifecycle exercises the whole lifecycle against a live API.
//
...
func TestAccResourceV2ComputerGroupsSmartGroup_01_Lifecycle(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: destroy.CheckDestroyed(testResource, "jamfpro_v2_computer_groups_smart_group", 20*time.Second),
		Steps: []resource.TestStep{
			...
			// is the most common way a generated provider is subtly wrong.
			{
				...
				// id: it is write-only, carried from configuration, which an import does not have
