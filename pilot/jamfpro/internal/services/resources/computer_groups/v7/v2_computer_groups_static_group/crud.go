...
// Create provisions a new jamfpro_v2_computer_groups_static_group.
func (r *V2ComputerGroupsStaticGroupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V2ComputerGroupsStaticGroupResourceModel
	...
	created, err := r.client.V2().ComputerGroups().StaticGroups().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v2_computer_groups_static_group state from the API.
func (r *V2ComputerGroupsStaticGroupResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V2ComputerGroupsStaticGroupResourceModel
...
// readState fetches jamfpro_v2_computer_groups_static_group and maps it onto state.
//
...
func (r *V2ComputerGroupsStaticGroupResource) readState(
	ctx context.Context,
	state *V2ComputerGroupsStaticGroupResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V2().ComputerGroups().StaticGroups().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V2ComputerGroupsStaticGroupResource) readAfterWrite(
	ctx context.Context,
	state *V2ComputerGroupsStaticGroupResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v2_computer_groups_static_group.
func (r *V2ComputerGroupsStaticGroupResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V2ComputerGroupsStaticGroupResourceModel
	...
	_, err := r.client.V2().ComputerGroups().StaticGroups().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v2_computer_groups_static_group.
func (r *V2ComputerGroupsStaticGroupResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V2ComputerGroupsStaticGroupResourceModel
	...
	err := r.client.V2().ComputerGroups().StaticGroups().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
