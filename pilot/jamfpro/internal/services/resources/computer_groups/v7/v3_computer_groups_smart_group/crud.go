...
// Create provisions a new jamfpro_v3_computer_groups_smart_group.
func (r *V3ComputerGroupsSmartGroupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V3ComputerGroupsSmartGroupResourceModel
	...
	created, err := r.client.V3().ComputerGroups().SmartGroups().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v3_computer_groups_smart_group state from the API.
func (r *V3ComputerGroupsSmartGroupResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V3ComputerGroupsSmartGroupResourceModel
...
// readState fetches jamfpro_v3_computer_groups_smart_group and maps it onto state.
//
...
func (r *V3ComputerGroupsSmartGroupResource) readState(
	ctx context.Context,
	state *V3ComputerGroupsSmartGroupResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V3().ComputerGroups().SmartGroups().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V3ComputerGroupsSmartGroupResource) readAfterWrite(
	ctx context.Context,
	state *V3ComputerGroupsSmartGroupResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v3_computer_groups_smart_group.
func (r *V3ComputerGroupsSmartGroupResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V3ComputerGroupsSmartGroupResourceModel
	...
	_, err := r.client.V3().ComputerGroups().SmartGroups().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v3_computer_groups_smart_group.
func (r *V3ComputerGroupsSmartGroupResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V3ComputerGroupsSmartGroupResourceModel
	...
	err := r.client.V3().ComputerGroups().SmartGroups().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
