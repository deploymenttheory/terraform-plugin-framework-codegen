...
import (
	...
	"github.com/deploymenttheory/terraform-plugin-framework-codegen/pilot/jamfpro/internal/services/resources/advanced_mobile_device_searches/v7/v1_advanced_mobile_device_search"
)

// The resource under test, and the helper that asks the API whether it is really there.
const address = "jamfpro_v1_advanced_mobile_device_search.test"

var testResource = v1_advanced_mobile_device_search.V1AdvancedMobileDeviceSearchTestResource{}

// TestAccResourceV1AdvancedMobileDeviceSearch_01_Lifecycle exercises the whole lifecycle against a live API.
//
...
func TestAccResourceV1AdvancedMobileDeviceSearch_01_Lifecycle(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: destroy.CheckDestroyed(testResource, "jamfpro_v1_advanced_mobile_device_search", 20*time.Second),
