...
// Create provisions a new jamfpro_v1_advanced_mobile_device_search.
func (r *V1AdvancedMobileDeviceSearchResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1AdvancedMobileDeviceSearchResourceModel
	...
	created, err := r.client.V1().AdvancedMobileDeviceSearches().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_advanced_mobile_device_search state from the API.
func (r *V1AdvancedMobileDeviceSearchResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1AdvancedMobileDeviceSearchResourceModel
...
// readState fetches jamfpro_v1_advanced_mobile_device_search and maps it onto state.
//
...
func (r *V1AdvancedMobileDeviceSearchResource) readState(
	ctx context.Context,
	state *V1AdvancedMobileDeviceSearchResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().AdvancedMobileDeviceSearches().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1AdvancedMobileDeviceSearchResource) readAfterWrite(
	ctx context.Context,
	state *V1AdvancedMobileDeviceSearchResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_advanced_mobile_device_search.
func (r *V1AdvancedMobileDeviceSearchResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1AdvancedMobileDeviceSearchResourceModel
	...
	_, err := r.client.V1().AdvancedMobileDeviceSearches().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_advanced_mobile_device_search.
func (r *V1AdvancedMobileDeviceSearchResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1AdvancedMobileDeviceSearchResourceModel
	...
	err := r.client.V1().AdvancedMobileDeviceSearches().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
