...
// Create provisions a new jamfpro_v1_return_to_service.
func (r *V1ReturnToServiceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1ReturnToServiceResourceModel
	...
	created, err := r.client.V1().ReturnToService().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_return_to_service state from the API.
func (r *V1ReturnToServiceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1ReturnToServiceResourceModel
...
// readState fetches jamfpro_v1_return_to_service and maps it onto state.
//
...
func (r *V1ReturnToServiceResource) readState(
	ctx context.Context,
	state *V1ReturnToServiceResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().ReturnToService().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1ReturnToServiceResource) readAfterWrite(
	ctx context.Context,
	state *V1ReturnToServiceResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_return_to_service.
func (r *V1ReturnToServiceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1ReturnToServiceResourceModel
	...
	_, err := r.client.V1().ReturnToService().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_return_to_service.
func (r *V1ReturnToServiceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1ReturnToServiceResourceModel
	...
	err := r.client.V1().ReturnToService().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
