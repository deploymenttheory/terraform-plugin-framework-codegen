...
// Create provisions a new jamfpro_v1_computers_inventory.
func (r *V1ComputersInventoryResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1ComputersInventoryResourceModel
	...
	created, err := r.client.V1().ComputersInventory().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_computers_inventory state from the API.
func (r *V1ComputersInventoryResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1ComputersInventoryResourceModel
...
// readState fetches jamfpro_v1_computers_inventory and maps it onto state.
//
...
func (r *V1ComputersInventoryResource) readState(
	ctx context.Context,
	state *V1ComputersInventoryResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().ComputersInventory().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1ComputersInventoryResource) readAfterWrite(
	ctx context.Context,
	state *V1ComputersInventoryResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
func (r *V1ComputersInventoryResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError(
		"Update is not supported by the API",
		"Every change to jamfpro_v1_computers_inventory forces replacement, so Terraform should never "+
			"have called Update. This is a bug in the provider; please report it.",
	)
}

// Delete removes a jamfpro_v1_computers_inventory.
func (r *V1ComputersInventoryResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1ComputersInventoryResourceModel
	...
	err := r.client.V1().ComputersInventory().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
