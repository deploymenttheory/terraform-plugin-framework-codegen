...
// Create provisions a new jamfpro_v3_computer_prestage.
func (r *V3ComputerPrestageResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V3ComputerPrestageResourceModel
	...
	created, err := r.client.V3().ComputerPrestages().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v3_computer_prestage state from the API.
func (r *V3ComputerPrestageResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V3ComputerPrestageResourceModel
...
// readState fetches jamfpro_v3_computer_prestage and maps it onto state.
//
...
func (r *V3ComputerPrestageResource) readState(
	ctx context.Context,
	state *V3ComputerPrestageResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V3().ComputerPrestages().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V3ComputerPrestageResource) readAfterWrite(
	ctx context.Context,
	state *V3ComputerPrestageResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v3_computer_prestage.
func (r *V3ComputerPrestageResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V3ComputerPrestageResourceModel
	...
	_, err := r.client.V3().ComputerPrestages().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v3_computer_prestage.
func (r *V3ComputerPrestageResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V3ComputerPrestageResourceModel
	...
	err := r.client.V3().ComputerPrestages().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
