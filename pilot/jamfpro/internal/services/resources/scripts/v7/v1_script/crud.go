...
// Create provisions a new jamfpro_v1_script.
func (r *V1ScriptResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	created, err := r.client.V1().Scripts().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_script state from the API.
...
// readState fetches jamfpro_v1_script and maps it onto state.
//
...
func (r *V1ScriptResource) readState(
	ctx context.Context,
	...
	remote, err := r.client.V1().Scripts().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1ScriptResource) readAfterWrite(
	ctx context.Context,
	state *V1ScriptResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
func (r *V1ScriptResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	_, err := r.client.V1().Scripts().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_script.
func (r *V1ScriptResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.V1().Scripts().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
