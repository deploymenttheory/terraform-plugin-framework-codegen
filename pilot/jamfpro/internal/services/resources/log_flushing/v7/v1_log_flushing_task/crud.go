...
// Create provisions a new jamfpro_v1_log_flushing_task.
func (r *V1LogFlushingTaskResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1LogFlushingTaskResourceModel
	...
	created, err := r.client.V1().LogFlushing().Task().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_log_flushing_task state from the API.
func (r *V1LogFlushingTaskResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1LogFlushingTaskResourceModel
...
// readState fetches jamfpro_v1_log_flushing_task and maps it onto state.
//
...
func (r *V1LogFlushingTaskResource) readState(
	ctx context.Context,
	state *V1LogFlushingTaskResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().LogFlushing().Task().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1LogFlushingTaskResource) readAfterWrite(
	ctx context.Context,
	state *V1LogFlushingTaskResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
func (r *V1LogFlushingTaskResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError(
		"Update is not supported by the API",
		"Every change to jamfpro_v1_log_flushing_task forces replacement, so Terraform should never "+
			"have called Update. This is a bug in the provider; please report it.",
	)
}

// Delete removes a jamfpro_v1_log_flushing_task.
func (r *V1LogFlushingTaskResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1LogFlushingTaskResourceModel
	...
	err := r.client.V1().LogFlushing().Task().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
