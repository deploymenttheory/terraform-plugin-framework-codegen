...
// Create provisions a new jamfpro_v1_advanced_user_content_search.
func (r *V1AdvancedUserContentSearchResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1AdvancedUserContentSearchResourceModel
	...
	created, err := r.client.V1().AdvancedUserContentSearches().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_advanced_user_content_search state from the API.
func (r *V1AdvancedUserContentSearchResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1AdvancedUserContentSearchResourceModel
...
// readState fetches jamfpro_v1_advanced_user_content_search and maps it onto state.
//
...
func (r *V1AdvancedUserContentSearchResource) readState(
	ctx context.Context,
	state *V1AdvancedUserContentSearchResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().AdvancedUserContentSearches().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1AdvancedUserContentSearchResource) readAfterWrite(
	ctx context.Context,
	state *V1AdvancedUserContentSearchResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_advanced_user_content_search.
func (r *V1AdvancedUserContentSearchResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1AdvancedUserContentSearchResourceModel
	...
	_, err := r.client.V1().AdvancedUserContentSearches().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_advanced_user_content_search.
func (r *V1AdvancedUserContentSearchResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1AdvancedUserContentSearchResourceModel
	...
	err := r.client.V1().AdvancedUserContentSearches().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
