...
import (
	...
	"github.com/deploymenttheory/terraform-plugin-framework-codegen/pilot/jamfpro/internal/services/resources/advanced_user_content_searches/v7/v1_advanced_user_content_search"
)

// The resource under test, and the helper that asks the API whether it is really there.
const address = "jamfpro_v1_advanced_user_content_search.test"

var testResource = v1_advanced_user_content_search.V1AdvancedUserContentSearchTestResource{}

// TestAccResourceV1AdvancedUserContentSearch_01_Lifecycle exercises the whole lifecycle against a live API.
//
...
func TestAccResourceV1AdvancedUserContentSearch_01_Lifecycle(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: destroy.CheckDestroyed(testResource, "jamfpro_v1_advanced_user_content_search", 20*time.Second),
