...
// Create provisions a new jamfpro_v1_mobile_device_groups_smart_group.
func (r *V1MobileDeviceGroupsSmartGroupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1MobileDeviceGroupsSmartGroupResourceModel
	...
	created, err := r.client.V1().MobileDeviceGroups().SmartGroups().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_mobile_device_groups_smart_group state from the API.
func (r *V1MobileDeviceGroupsSmartGroupResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1MobileDeviceGroupsSmartGroupResourceModel
...
// readState fetches jamfpro_v1_mobile_device_groups_smart_group and maps it onto state.
//
...
func (r *V1MobileDeviceGroupsSmartGroupResource) readState(
	ctx context.Context,
	state *V1MobileDeviceGroupsSmartGroupResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().MobileDeviceGroups().SmartGroups().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1MobileDeviceGroupsSmartGroupResource) readAfterWrite(
	ctx context.Context,
	state *V1MobileDeviceGroupsSmartGroupResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_mobile_device_groups_smart_group.
func (r *V1MobileDeviceGroupsSmartGroupResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1MobileDeviceGroupsSmartGroupResourceModel
	...
	_, err := r.client.V1().MobileDeviceGroups().SmartGroups().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_mobile_device_groups_smart_group.
func (r *V1MobileDeviceGroupsSmartGroupResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1MobileDeviceGroupsSmartGroupResourceModel
	...
	err := r.client.V1().MobileDeviceGroups().SmartGroups().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
