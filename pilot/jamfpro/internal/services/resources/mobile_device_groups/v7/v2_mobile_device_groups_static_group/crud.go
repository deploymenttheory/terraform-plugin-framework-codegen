...
// Create provisions a new jamfpro_v2_mobile_device_groups_static_group.
func (r *V2MobileDeviceGroupsStaticGroupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V2MobileDeviceGroupsStaticGroupResourceModel
	...
	created, err := r.client.V2().MobileDeviceGroups().StaticGroups().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v2_mobile_device_groups_static_group state from the API.
func (r *V2MobileDeviceGroupsStaticGroupResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V2MobileDeviceGroupsStaticGroupResourceModel
...
// readState fetches jamfpro_v2_mobile_device_groups_static_group and maps it onto state.
//
...
func (r *V2MobileDeviceGroupsStaticGroupResource) readState(
	ctx context.Context,
	state *V2MobileDeviceGroupsStaticGroupResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V2().MobileDeviceGroups().StaticGroups().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V2MobileDeviceGroupsStaticGroupResource) readAfterWrite(
	ctx context.Context,
	state *V2MobileDeviceGroupsStaticGroupResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v2_mobile_device_groups_static_group.
func (r *V2MobileDeviceGroupsStaticGroupResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V2MobileDeviceGroupsStaticGroupResourceModel
	...
	_, err := r.client.V2().MobileDeviceGroups().StaticGroups().ById(state.ID.ValueString()).Patch(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v2_mobile_device_groups_static_group.
func (r *V2MobileDeviceGroupsStaticGroupResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V2MobileDeviceGroupsStaticGroupResourceModel
	...
	err := r.client.V2().MobileDeviceGroups().StaticGroups().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
