...
// Create provisions a new jamfpro_v1_computer_extension_attribute.
func (r *V1ComputerExtensionAttributeResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1ComputerExtensionAttributeResourceModel
	...
	created, err := r.client.V1().ComputerExtensionAttributes().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_computer_extension_attribute state from the API.
func (r *V1ComputerExtensionAttributeResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1ComputerExtensionAttributeResourceModel
...
// readState fetches jamfpro_v1_computer_extension_attribute and maps it onto state.
//
...
func (r *V1ComputerExtensionAttributeResource) readState(
	ctx context.Context,
	state *V1ComputerExtensionAttributeResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().ComputerExtensionAttributes().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1ComputerExtensionAttributeResource) readAfterWrite(
	ctx context.Context,
	state *V1ComputerExtensionAttributeResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_computer_extension_attribute.
func (r *V1ComputerExtensionAttributeResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1ComputerExtensionAttributeResourceModel
	...
	_, err := r.client.V1().ComputerExtensionAttributes().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_computer_extension_attribute.
func (r *V1ComputerExtensionAttributeResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1ComputerExtensionAttributeResourceModel
	...
	err := r.client.V1().ComputerExtensionAttributes().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
