...
// Create provisions a new jamfpro_v1_volume_purchasing_location.
func (r *V1VolumePurchasingLocationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1VolumePurchasingLocationResourceModel
	...
	created, err := r.client.V1().VolumePurchasingLocations().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_volume_purchasing_location state from the API.
func (r *V1VolumePurchasingLocationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1VolumePurchasingLocationResourceModel
...
// readState fetches jamfpro_v1_volume_purchasing_location and maps it onto state.
//
...
func (r *V1VolumePurchasingLocationResource) readState(
	ctx context.Context,
	state *V1VolumePurchasingLocationResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().VolumePurchasingLocations().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1VolumePurchasingLocationResource) readAfterWrite(
	ctx context.Context,
	state *V1VolumePurchasingLocationResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_volume_purchasing_location.
func (r *V1VolumePurchasingLocationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1VolumePurchasingLocationResourceModel
	...
	_, err := r.client.V1().VolumePurchasingLocations().ById(state.ID.ValueString()).Patch(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_volume_purchasing_location.
func (r *V1VolumePurchasingLocationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1VolumePurchasingLocationResourceModel
	...
	err := r.client.V1().VolumePurchasingLocations().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
