...
// Create provisions a new jamfpro_v1_self_service_branding_io.
func (r *V1SelfServiceBrandingIoResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1SelfServiceBrandingIoResourceModel
	...
	created, err := r.client.V1().SelfService().Branding().Ios().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_self_service_branding_io state from the API.
func (r *V1SelfServiceBrandingIoResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1SelfServiceBrandingIoResourceModel
...
// readState fetches jamfpro_v1_self_service_branding_io and maps it onto state.
//
...
func (r *V1SelfServiceBrandingIoResource) readState(
	ctx context.Context,
	state *V1SelfServiceBrandingIoResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().SelfService().Branding().Ios().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1SelfServiceBrandingIoResource) readAfterWrite(
	ctx context.Context,
	state *V1SelfServiceBrandingIoResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_self_service_branding_io.
func (r *V1SelfServiceBrandingIoResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1SelfServiceBrandingIoResourceModel
	...
	_, err := r.client.V1().SelfService().Branding().Ios().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_self_service_branding_io.
func (r *V1SelfServiceBrandingIoResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1SelfServiceBrandingIoResourceModel
	...
	err := r.client.V1().SelfService().Branding().Ios().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
