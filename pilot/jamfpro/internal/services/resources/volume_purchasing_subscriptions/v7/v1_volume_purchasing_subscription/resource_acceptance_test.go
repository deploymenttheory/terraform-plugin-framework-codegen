...
import (
	...
	"github.com/deploymenttheory/terraform-plugin-framework-codegen/pilot/jamfpro/internal/services/resources/volume_purchasing_subscriptions/v7/v1_volume_purchasing_subscription"
)

// The resource under test, and the helper that asks the API whether it is really there.
const address = "jamfpro_v1_volume_purchasing_subscription.test"

var testResource = v1_volume_purchasing_subscription.V1VolumePurchasingSubscriptionTestResource{}

// TestAccResourceV1VolumePurchasingSubscription_01_Lifecycle exercises the whole lifecycle against a live API.
//
...
func TestAccResourceV1VolumePurchasingSubscription_01_Lifecycle(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: destroy.CheckDestroyed(testResource, "jamfpro_v1_volume_purchasing_subscription", 20*time.Second),
