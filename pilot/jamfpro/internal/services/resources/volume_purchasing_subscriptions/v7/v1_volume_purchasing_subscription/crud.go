...
// Create provisions a new jamfpro_v1_volume_purchasing_subscription.
func (r *V1VolumePurchasingSubscriptionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1VolumePurchasingSubscriptionResourceModel
	...
	created, err := r.client.V1().VolumePurchasingSubscriptions().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_volume_purchasing_subscription state from the API.
func (r *V1VolumePurchasingSubscriptionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1VolumePurchasingSubscriptionResourceModel
...
// readState fetches jamfpro_v1_volume_purchasing_subscription and maps it onto state.
//
...
func (r *V1VolumePurchasingSubscriptionResource) readState(
	ctx context.Context,
	state *V1VolumePurchasingSubscriptionResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().VolumePurchasingSubscriptions().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1VolumePurchasingSubscriptionResource) readAfterWrite(
	ctx context.Context,
	state *V1VolumePurchasingSubscriptionResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_volume_purchasing_subscription.
func (r *V1VolumePurchasingSubscriptionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1VolumePurchasingSubscriptionResourceModel
	...
	_, err := r.client.V1().VolumePurchasingSubscriptions().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_volume_purchasing_subscription.
func (r *V1VolumePurchasingSubscriptionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1VolumePurchasingSubscriptionResourceModel
	...
	err := r.client.V1().VolumePurchasingSubscriptions().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
