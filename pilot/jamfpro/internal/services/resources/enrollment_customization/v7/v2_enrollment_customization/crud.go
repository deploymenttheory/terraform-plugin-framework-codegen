...
// Create provisions a new jamfpro_v2_enrollment_customization.
func (r *V2EnrollmentCustomizationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V2EnrollmentCustomizationResourceModel
	...
	created, err := r.client.V2().EnrollmentCustomizations().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v2_enrollment_customization state from the API.
func (r *V2EnrollmentCustomizationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V2EnrollmentCustomizationResourceModel
...
// readState fetches jamfpro_v2_enrollment_customization and maps it onto state.
//
...
func (r *V2EnrollmentCustomizationResource) readState(
	ctx context.Context,
	state *V2EnrollmentCustomizationResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V2().EnrollmentCustomizations().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V2EnrollmentCustomizationResource) readAfterWrite(
	ctx context.Context,
	state *V2EnrollmentCustomizationResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v2_enrollment_customization.
func (r *V2EnrollmentCustomizationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V2EnrollmentCustomizationResourceModel
	...
	_, err := r.client.V2().EnrollmentCustomizations().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v2_enrollment_customization.
func (r *V2EnrollmentCustomizationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V2EnrollmentCustomizationResourceModel
	...
	err := r.client.V2().EnrollmentCustomizations().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
