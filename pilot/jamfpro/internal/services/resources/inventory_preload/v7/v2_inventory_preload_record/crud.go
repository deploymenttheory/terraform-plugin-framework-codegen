...
// Create provisions a new jamfpro_v2_inventory_preload_record.
func (r *V2InventoryPreloadRecordResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V2InventoryPreloadRecordResourceModel
	...
	created, err := r.client.V2().InventoryPreload().Records().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v2_inventory_preload_record state from the API.
func (r *V2InventoryPreloadRecordResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V2InventoryPreloadRecordResourceModel
...
// readState fetches jamfpro_v2_inventory_preload_record and maps it onto state.
//
...
func (r *V2InventoryPreloadRecordResource) readState(
	ctx context.Context,
	state *V2InventoryPreloadRecordResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V2().InventoryPreload().Records().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V2InventoryPreloadRecordResource) readAfterWrite(
	ctx context.Context,
	state *V2InventoryPreloadRecordResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v2_inventory_preload_record.
func (r *V2InventoryPreloadRecordResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V2InventoryPreloadRecordResourceModel
	...
	_, err := r.client.V2().InventoryPreload().Records().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v2_inventory_preload_record.
func (r *V2InventoryPreloadRecordResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V2InventoryPreloadRecordResourceModel
	...
	err := r.client.V2().InventoryPreload().Records().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
