...
// Create provisions a new jamfpro_v1_category.
func (r *V1CategoryResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1CategoryResourceModel
	...
	created, err := r.client.V1().Categories().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_category state from the API.
func (r *V1CategoryResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1CategoryResourceModel
...
// readState fetches jamfpro_v1_category and maps it onto state.
//
...
func (r *V1CategoryResource) readState(
	ctx context.Context,
	state *V1CategoryResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().Categories().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1CategoryResource) readAfterWrite(
	ctx context.Context,
	state *V1CategoryResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_category.
func (r *V1CategoryResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1CategoryResourceModel
	...
	_, err := r.client.V1().Categories().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_category.
func (r *V1CategoryResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1CategoryResourceModel
	...
	err := r.client.V1().Categories().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
