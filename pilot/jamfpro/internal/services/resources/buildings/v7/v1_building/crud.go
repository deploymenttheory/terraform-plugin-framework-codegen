...
// Create provisions a new jamfpro_v1_building.
func (r *V1BuildingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1BuildingResourceModel
	...
	created, err := r.client.V1().Buildings().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_building state from the API.
func (r *V1BuildingResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1BuildingResourceModel
...
// readState fetches jamfpro_v1_building and maps it onto state.
//
...
func (r *V1BuildingResource) readState(
	ctx context.Context,
	state *V1BuildingResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().Buildings().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1BuildingResource) readAfterWrite(
	ctx context.Context,
	state *V1BuildingResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_building.
func (r *V1BuildingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1BuildingResourceModel
	...
	_, err := r.client.V1().Buildings().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_building.
func (r *V1BuildingResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1BuildingResourceModel
	...
	err := r.client.V1().Buildings().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
