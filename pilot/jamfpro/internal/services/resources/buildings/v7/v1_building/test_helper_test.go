...
// V1BuildingTestResource answers whether a jamfpro_v1_building is really in the API.
//
...
type V1BuildingTestResource struct{}
...
func (V1BuildingTestResource) Exists(
	ctx context.Context,
	...
	return exists.Check(ctx, state, func(
		...
		_, err := client.V1().Buildings().ById(state.ID).Get(ctx, nil)
