...
// Create provisions a new jamfpro_v1_self_service_branding_maco.
func (r *V1SelfServiceBrandingMacoResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1SelfServiceBrandingMacoResourceModel
	...
	created, err := r.client.V1().SelfService().Branding().Macos().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_self_service_branding_maco state from the API.
func (r *V1SelfServiceBrandingMacoResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1SelfServiceBrandingMacoResourceModel
...
// readState fetches jamfpro_v1_self_service_branding_maco and maps it onto state.
//
...
func (r *V1SelfServiceBrandingMacoResource) readState(
	ctx context.Context,
	state *V1SelfServiceBrandingMacoResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().SelfService().Branding().Macos().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1SelfServiceBrandingMacoResource) readAfterWrite(
	ctx context.Context,
	state *V1SelfServiceBrandingMacoResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_self_service_branding_maco.
func (r *V1SelfServiceBrandingMacoResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1SelfServiceBrandingMacoResourceModel
	...
	_, err := r.client.V1().SelfService().Branding().Macos().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_self_service_branding_maco.
func (r *V1SelfServiceBrandingMacoResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1SelfServiceBrandingMacoResourceModel
	...
	err := r.client.V1().SelfService().Branding().Macos().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
