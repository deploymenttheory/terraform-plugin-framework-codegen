...
// Create provisions a new jamfpro_v1_department.
func (r *V1DepartmentResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1DepartmentResourceModel
	...
	created, err := r.client.V1().Departments().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_department state from the API.
func (r *V1DepartmentResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1DepartmentResourceModel
...
// readState fetches jamfpro_v1_department and maps it onto state.
//
...
func (r *V1DepartmentResource) readState(
	ctx context.Context,
	state *V1DepartmentResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().Departments().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1DepartmentResource) readAfterWrite(
	ctx context.Context,
	state *V1DepartmentResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_department.
func (r *V1DepartmentResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1DepartmentResourceModel
	...
	_, err := r.client.V1().Departments().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_department.
func (r *V1DepartmentResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1DepartmentResourceModel
	...
	err := r.client.V1().Departments().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
