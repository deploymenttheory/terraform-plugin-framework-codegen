...
// V1DepartmentTestResource answers whether a jamfpro_v1_department is really in the API.
//
...
type V1DepartmentTestResource struct{}
...
func (V1DepartmentTestResource) Exists(
	ctx context.Context,
	...
	return exists.Check(ctx, state, func(
		...
		_, err := client.V1().Departments().ById(state.ID).Get(ctx, nil)
