...
// Create provisions a new jamfpro_v1_mobile_device_extension_attribute.
func (r *V1MobileDeviceExtensionAttributeResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1MobileDeviceExtensionAttributeResourceModel
	...
	created, err := r.client.V1().MobileDeviceExtensionAttributes().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_mobile_device_extension_attribute state from the API.
func (r *V1MobileDeviceExtensionAttributeResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1MobileDeviceExtensionAttributeResourceModel
...
// readState fetches jamfpro_v1_mobile_device_extension_attribute and maps it onto state.
//
...
func (r *V1MobileDeviceExtensionAttributeResource) readState(
	ctx context.Context,
	state *V1MobileDeviceExtensionAttributeResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().MobileDeviceExtensionAttributes().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1MobileDeviceExtensionAttributeResource) readAfterWrite(
	ctx context.Context,
	state *V1MobileDeviceExtensionAttributeResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_mobile_device_extension_attribute.
func (r *V1MobileDeviceExtensionAttributeResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1MobileDeviceExtensionAttributeResourceModel
	...
	_, err := r.client.V1().MobileDeviceExtensionAttributes().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_mobile_device_extension_attribute.
func (r *V1MobileDeviceExtensionAttributeResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1MobileDeviceExtensionAttributeResourceModel
	...
	err := r.client.V1().MobileDeviceExtensionAttributes().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
