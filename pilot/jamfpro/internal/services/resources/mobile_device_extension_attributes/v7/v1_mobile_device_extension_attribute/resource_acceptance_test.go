...
import (
	...
	"github.com/deploymenttheory/terraform-plugin-framework-codegen/pilot/jamfpro/internal/services/resources/mobile_device_extension_attributes/v7/v1_mobile_device_extension_attribute"
)

// The resource under test, and the helper that asks the API whether it is really there.
const address = "jamfpro_v1_mobile_device_extension_attribute.test"

var testResource = v1_mobile_device_extension_attribute.V1MobileDeviceExtensionAttributeTestResource{}

// TestAccResourceV1MobileDeviceExtensionAttribute_01_Lifecycle exercises the whole lifecycle against a live API.
//
...
func TestAccResourceV1MobileDeviceExtensionAttribute_01_Lifecycle(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: destroy.CheckDestroyed(testResource, "jamfpro_v1_mobile_device_extension_attribute", 20*time.Second),
