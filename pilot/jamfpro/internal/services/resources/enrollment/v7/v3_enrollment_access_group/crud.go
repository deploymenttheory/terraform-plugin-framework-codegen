...
// Create provisions a new jamfpro_v3_enrollment_access_group.
func (r *V3EnrollmentAccessGroupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V3EnrollmentAccessGroupResourceModel
	...
	created, err := r.client.V3().Enrollment().AccessGroups().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v3_enrollment_access_group state from the API.
func (r *V3EnrollmentAccessGroupResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V3EnrollmentAccessGroupResourceModel
...
// readState fetches jamfpro_v3_enrollment_access_group and maps it onto state.
//
...
func (r *V3EnrollmentAccessGroupResource) readState(
	ctx context.Context,
	state *V3EnrollmentAccessGroupResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V3().Enrollment().AccessGroups().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V3EnrollmentAccessGroupResource) readAfterWrite(
	ctx context.Context,
	state *V3EnrollmentAccessGroupResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v3_enrollment_access_group.
func (r *V3EnrollmentAccessGroupResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V3EnrollmentAccessGroupResourceModel
	...
	_, err := r.client.V3().Enrollment().AccessGroups().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v3_enrollment_access_group.
func (r *V3EnrollmentAccessGroupResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V3EnrollmentAccessGroupResourceModel
	...
	err := r.client.V3().Enrollment().AccessGroups().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
