...
// Create provisions a new jamfpro_v1_api_integration.
func (r *V1APIIntegrationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1APIIntegrationResourceModel
	...
	created, err := r.client.V1().ApiIntegrations().Post(ctx, body, nil)
	if err != nil {
	...
	// record of.
	plan.ID = convert.PtrInt32ToFrameworkInt64(created.GetId())
...
// Read refreshes jamfpro_v1_api_integration state from the API.
func (r *V1APIIntegrationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1APIIntegrationResourceModel
...
// readState fetches jamfpro_v1_api_integration and maps it onto state.
//
...
func (r *V1APIIntegrationResource) readState(
	ctx context.Context,
	state *V1APIIntegrationResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().ApiIntegrations().ById(strconv.FormatInt(state.ID.ValueInt64(), 10)).Get(ctx, nil)
	if err != nil {
...
func (r *V1APIIntegrationResource) readAfterWrite(
	ctx context.Context,
	state *V1APIIntegrationResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_api_integration.
func (r *V1APIIntegrationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1APIIntegrationResourceModel
	...
	_, err := r.client.V1().ApiIntegrations().ById(strconv.FormatInt(state.ID.ValueInt64(), 10)).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_api_integration.
func (r *V1APIIntegrationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1APIIntegrationResourceModel
	...
	err := r.client.V1().ApiIntegrations().ById(strconv.FormatInt(state.ID.ValueInt64(), 10)).Delete(ctx, nil)
	if err != nil {
