...
// Create provisions a new jamfpro_v1_account.
func (r *V1AccountResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1AccountResourceModel
	...
	created, err := r.client.V1().Accounts().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_account state from the API.
func (r *V1AccountResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1AccountResourceModel
...
// readState fetches jamfpro_v1_account and maps it onto state.
//
...
func (r *V1AccountResource) readState(
	ctx context.Context,
	state *V1AccountResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().Accounts().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1AccountResource) readAfterWrite(
	ctx context.Context,
	state *V1AccountResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_account.
func (r *V1AccountResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1AccountResourceModel
	...
	_, err := r.client.V1().Accounts().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_account.
func (r *V1AccountResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1AccountResourceModel
	...
	err := r.client.V1().Accounts().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
