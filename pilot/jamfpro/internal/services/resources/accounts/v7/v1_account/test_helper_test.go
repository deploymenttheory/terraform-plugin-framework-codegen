...
// V1AccountTestResource answers whether a jamfpro_v1_account is really in the API.
//
...
type V1AccountTestResource struct{}
...
func (V1AccountTestResource) Exists(
	ctx context.Context,
	...
	return exists.Check(ctx, state, func(
		...
		_, err := client.V1().Accounts().ById(state.ID).Get(ctx, nil)
