...
// Create provisions a new jamfpro_v2_mobile_device_prestage.
func (r *V2MobileDevicePrestageResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V2MobileDevicePrestageResourceModel
	...
	created, err := r.client.V2().MobileDevicePrestages().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v2_mobile_device_prestage state from the API.
func (r *V2MobileDevicePrestageResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V2MobileDevicePrestageResourceModel
...
// readState fetches jamfpro_v2_mobile_device_prestage and maps it onto state.
//
...
func (r *V2MobileDevicePrestageResource) readState(
	ctx context.Context,
	state *V2MobileDevicePrestageResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V2().MobileDevicePrestages().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V2MobileDevicePrestageResource) readAfterWrite(
	ctx context.Context,
	state *V2MobileDevicePrestageResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v2_mobile_device_prestage.
func (r *V2MobileDevicePrestageResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V2MobileDevicePrestageResourceModel
	...
	_, err := r.client.V2().MobileDevicePrestages().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v2_mobile_device_prestage.
func (r *V2MobileDevicePrestageResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V2MobileDevicePrestageResourceModel
	...
	err := r.client.V2().MobileDevicePrestages().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
