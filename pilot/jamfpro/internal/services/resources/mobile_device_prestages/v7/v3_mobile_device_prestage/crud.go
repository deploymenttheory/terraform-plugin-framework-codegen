...
// Create provisions a new jamfpro_v3_mobile_device_prestage.
func (r *V3MobileDevicePrestageResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V3MobileDevicePrestageResourceModel
	...
	created, err := r.client.V3().MobileDevicePrestages().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v3_mobile_device_prestage state from the API.
func (r *V3MobileDevicePrestageResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V3MobileDevicePrestageResourceModel
...
// readState fetches jamfpro_v3_mobile_device_prestage and maps it onto state.
//
...
func (r *V3MobileDevicePrestageResource) readState(
	ctx context.Context,
	state *V3MobileDevicePrestageResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V3().MobileDevicePrestages().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V3MobileDevicePrestageResource) readAfterWrite(
	ctx context.Context,
	state *V3MobileDevicePrestageResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v3_mobile_device_prestage.
func (r *V3MobileDevicePrestageResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V3MobileDevicePrestageResourceModel
	...
	_, err := r.client.V3().MobileDevicePrestages().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v3_mobile_device_prestage.
func (r *V3MobileDevicePrestageResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V3MobileDevicePrestageResourceModel
	...
	err := r.client.V3().MobileDevicePrestages().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
