...
// Create provisions a new jamfpro_v1_api_role.
func (r *V1APIRoleResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V1APIRoleResourceModel
	...
	created, err := r.client.V1().ApiRoles().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v1_api_role state from the API.
func (r *V1APIRoleResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V1APIRoleResourceModel
...
// readState fetches jamfpro_v1_api_role and maps it onto state.
//
...
func (r *V1APIRoleResource) readState(
	ctx context.Context,
	state *V1APIRoleResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V1().ApiRoles().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V1APIRoleResource) readAfterWrite(
	ctx context.Context,
	state *V1APIRoleResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v1_api_role.
func (r *V1APIRoleResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V1APIRoleResourceModel
	...
	_, err := r.client.V1().ApiRoles().ById(state.ID.ValueString()).Put(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v1_api_role.
func (r *V1APIRoleResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V1APIRoleResourceModel
	...
	err := r.client.V1().ApiRoles().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
