...
// Create provisions a new jamfpro_v3_patch_software_title_configuration.
func (r *V3PatchSoftwareTitleConfigurationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V3PatchSoftwareTitleConfigurationResourceModel
	...
	created, err := r.client.V3().PatchSoftwareTitleConfigurations().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v3_patch_software_title_configuration state from the API.
func (r *V3PatchSoftwareTitleConfigurationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V3PatchSoftwareTitleConfigurationResourceModel
...
// readState fetches jamfpro_v3_patch_software_title_configuration and maps it onto state.
//
...
func (r *V3PatchSoftwareTitleConfigurationResource) readState(
	ctx context.Context,
	state *V3PatchSoftwareTitleConfigurationResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V3().PatchSoftwareTitleConfigurations().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V3PatchSoftwareTitleConfigurationResource) readAfterWrite(
	ctx context.Context,
	state *V3PatchSoftwareTitleConfigurationResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v3_patch_software_title_configuration.
func (r *V3PatchSoftwareTitleConfigurationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V3PatchSoftwareTitleConfigurationResourceModel
	...
	_, err := r.client.V3().PatchSoftwareTitleConfigurations().ById(state.ID.ValueString()).Patch(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v3_patch_software_title_configuration.
func (r *V3PatchSoftwareTitleConfigurationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V3PatchSoftwareTitleConfigurationResourceModel
	...
	err := r.client.V3().PatchSoftwareTitleConfigurations().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
