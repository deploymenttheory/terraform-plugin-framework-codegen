...
// Create provisions a new jamfpro_v2_patch_software_title_configuration.
func (r *V2PatchSoftwareTitleConfigurationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan V2PatchSoftwareTitleConfigurationResourceModel
	...
	created, err := r.client.V2().PatchSoftwareTitleConfigurations().Post(ctx, body, nil)
	if err != nil {
...
// Read refreshes jamfpro_v2_patch_software_title_configuration state from the API.
func (r *V2PatchSoftwareTitleConfigurationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state V2PatchSoftwareTitleConfigurationResourceModel
...
// readState fetches jamfpro_v2_patch_software_title_configuration and maps it onto state.
//
...
func (r *V2PatchSoftwareTitleConfigurationResource) readState(
	ctx context.Context,
	state *V2PatchSoftwareTitleConfigurationResourceModel,
	op errors.Operation,
) (bool, diag.Diagnostics) {
	var diags diag.Diagnostics

	remote, err := r.client.V2().PatchSoftwareTitleConfigurations().ById(state.ID.ValueString()).Get(ctx, nil)
	if err != nil {
...
func (r *V2PatchSoftwareTitleConfigurationResource) readAfterWrite(
	ctx context.Context,
	state *V2PatchSoftwareTitleConfigurationResourceModel,
	op errors.Operation,
) diag.Diagnostics {
...
// Update applies configuration changes to an existing jamfpro_v2_patch_software_title_configuration.
func (r *V2PatchSoftwareTitleConfigurationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state V2PatchSoftwareTitleConfigurationResourceModel
	...
	_, err := r.client.V2().PatchSoftwareTitleConfigurations().ById(state.ID.ValueString()).Patch(ctx, body, nil)
	if err != nil {
...
// Delete removes a jamfpro_v2_patch_software_title_configuration.
func (r *V2PatchSoftwareTitleConfigurationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state V2PatchSoftwareTitleConfigurationResourceModel
	...
	err := r.client.V2().PatchSoftwareTitleConfigurations().ById(state.ID.ValueString()).Delete(ctx, nil)
	if err != nil {
