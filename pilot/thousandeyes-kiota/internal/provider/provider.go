...
func (p *Provider) Schema(_ context.Context, _ provider.SchemaRequest, resp *provider.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Manages ThousandEyes resources.",
		Attributes: map[string]schema.Attribute{
			"bearer_token": schema.StringAttribute{
				MarkdownDescription: "A bearer token for the ThousandEyes API, sent as " +
					...
					"ThousandEyes documentation. The provider never logs it.",
				Optional:  true,
				Sensitive: true,
			},
