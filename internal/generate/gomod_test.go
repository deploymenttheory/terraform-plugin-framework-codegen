...
// TestUnit_Generate_ModuleGoVersionsAreCompatible guards a failure that is invisible
...
func TestUnit_Generate_ModuleGoVersionsAreCompatible(t *testing.T) {
	t.Parallel()
...
// TestUnit_Generate_CommittedBlueprintDoesNotClaimAnAbsentSnapshot keeps a committed
...
func TestUnit_Generate_CommittedBlueprintDoesNotClaimAnAbsentSnapshot(t *testing.T) {
	t.Parallel()
