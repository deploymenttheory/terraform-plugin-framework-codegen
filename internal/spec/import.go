...
func ToBlueprint(s hcspec.Specification, opts Options) (blueprint.Blueprint, Report, error) {
	var r Report
...
// namingOpts matches internal/openapi's, so a blueprint imported from a
