...
// separately in TestUnit_Spec_Defaults.
...
// TestUnit_Spec_EveryKindExportsAsAResource drives all thirteen branches of the
// resource switch, with validators, modifiers and defaults attached to each.
func TestUnit_Spec_EveryKindExportsAsAResource(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_EveryKindExportsAsADataSource drives the datasource switch.
//
...
func TestUnit_Spec_EveryKindExportsAsADataSource(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_ElementTypesOfEveryScalar covers the element-type walk, which is
// a separate switch from the attribute one and equally unreachable from the pilot.
func TestUnit_Spec_ElementTypesOfEveryScalar(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_NestedObjectInAnElementType covers the branch that flattens a
...
func TestUnit_Spec_NestedObjectInAnElementType(t *testing.T) {
	t.Parallel()
...
func TestUnit_Spec_ObjectTypeRefusals(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_ResourceLossesAreSelective: the resource-level sections are
// reported only when populated, for the same reason Behaviour is.
func TestUnit_Spec_ResourceLossesAreSelective(t *testing.T) {
	t.Parallel()
