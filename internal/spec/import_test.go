...
// TestUnit_Spec_Roundtrip asserts the schema slice survives export and import
// unchanged.
//
...
// TestUnit_Spec_Severities disagree with each other.
func TestUnit_Spec_Roundtrip(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_RoundtripStaticDefaults covers each static default type through
// both directions, which the every-kind fixture cannot: it uses custom defaults,
// because only four kinds accept a static one.
func TestUnit_Spec_RoundtripStaticDefaults(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_ExportImportExportIsByteStable is the property the milestone
// names.
//
...
func TestUnit_Spec_ExportImportExportIsByteStable(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_Drafts is the guard on the whole draft mechanism.
//
...
func TestUnit_Spec_Drafts(t *testing.T) {
	t.Parallel()
...
func TestUnit_Spec_ImportRequiresAProviderName(t *testing.T) {
	t.Parallel()
...
func TestUnit_Spec_ImportRefusals(t *testing.T) {
	t.Parallel()

	tests := []struct {
		name string
		in   hcspec.Specification
		want string
		is   error
	}{
		{
			name: "no resources",
			in:   hcspec.Specification{Version: SpecVersion},
			want: "no resources",
			is:   ErrInvalidSpec,
		},
		{
...
func specOf(res resource.Resource) hcspec.Specification {
	return hcspec.Specification{Version: SpecVersion, Resources: resource.Resources{res}}
}
...
// TestUnit_Spec_ImportConvertsBlocks: a block and a nested attribute are the same
...
func TestUnit_Spec_ImportConvertsBlocks(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_ImportPromotesAPlainDescription: a document that sets only the
...
func TestUnit_Spec_ImportPromotesAPlainDescription(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_ImportedBlueprintIsNotEmittable is the point of the draft
...
func TestUnit_Spec_ImportedBlueprintIsNotEmittable(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_ImportReportsWhatMustBeAuthored: the unauthored fields are the
// whole output a human acts on, so their absence is reported rather than left to be
// discovered by running emit.
func TestUnit_Spec_ImportReportsWhatMustBeAuthored(t *testing.T) {
	t.Parallel()
...
func TestUnit_Spec_ImportSkipsDataSourcesAndProviderSchema(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_ImportCustomTypeIsReported: the blueprint has no field for a
// custom type and value, so it is dropped -- loudly, because it is a deliberate
// choice somebody made in the source document.
func TestUnit_Spec_ImportCustomTypeIsReported(t *testing.T) {
	t.Parallel()
...
func TestUnit_Spec_ImportSortsResourcesByKey(t *testing.T) {
	t.Parallel()

	in := hcspec.Specification{Version: SpecVersion, Resources: resource.Resources{
...
func TestUnit_Spec_LowerFirstRune(t *testing.T) {
	t.Parallel()
...
func TestUnit_Spec_PresenceFromToleratesAnUnknownValue(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_ImportDefaultsCarryBothForms covers a default that has a custom
...
// silently.
func TestUnit_Spec_ImportDefaultsCarryBothForms(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_ImportSkipsNilValidators: upstream's slice elements hold a pointer,
...
func TestUnit_Spec_ImportSkipsNilValidators(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_ImportCollectionsOfCollections covers the recursive element walk in
// the import direction, which the pilot only exercises one level deep.
func TestUnit_Spec_ImportCollectionsOfCollections(t *testing.T) {
	t.Parallel()
...
// TestUnit_Spec_ImportEveryScalarElementType covers the remaining element branches.
func TestUnit_Spec_ImportEveryScalarElementType(t *testing.T) {
	t.Parallel()
...
func TestUnit_Spec_Unauthored(t *testing.T) {
	t.Parallel()
