...
func readConvert(fb *sdkbind.FieldBinding) (string, error) {
	simple := map[string]string{
		...
		"FromNestedCollectionSlice":             "APIToFrameworkNestedCollectionList",
		"FromNestedCollectionMap":               "APIToFrameworkNestedCollectionMap",
		"FromNestedCollectionMapAdditionalData": "APIToFrameworkNestedCollectionMapAdditionalData",
		"FromNestedCollectionSliceAdditionalData": "APIToFrameworkNestedCollectionListAdditionalData",
		"FromNestedCollectionSliceUntypedNode":    "APIToFrameworkNestedCollectionListUntypedNode",
	}
...
func writeConvert(fb *sdkbind.FieldBinding) (writeConversion, error) {
	simple := map[string]writeConversion{
		...
		"ToNestedCollectionSlice":               {fn: "FrameworkToAPINestedCollectionList", needsCtx: true, returnsErr: true},
		"ToNestedCollectionMap":                 {fn: "FrameworkToAPINestedCollectionMap", needsCtx: true, returnsErr: true},
		"ToNestedCollectionMapAdditionalData":   {fn: "FrameworkToAPINestedCollectionMapAdditionalData", needsCtx: true, returnsErr: true},
		"ToNestedCollectionSliceAdditionalData": {fn: "FrameworkToAPINestedCollectionListAdditionalData", needsCtx: true, returnsErr: true},
		"ToNestedCollectionSliceUntypedNode":    {fn: "FrameworkToAPINestedCollectionListUntypedNode", needsCtx: true, returnsErr: true},
	}
