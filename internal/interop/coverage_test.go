...
func TestUnit_Interop_Conformance(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_Presence covers all four spellings and the case a cast would
// have laundered.
//
...
// TestUnit_Interop_Defaults covers the one place in the mapping that needs a real
...
// not compile.
func TestUnit_Interop_Defaults(t *testing.T) {
	t.Parallel()
...
func TestUnit_Interop_DefaultValuesAreTyped(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_Downgrade covers the widening cases and asserts they are
// reported rather than silent.
func TestUnit_Interop_Downgrade(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_UniformLossesAreAggregated pins the readability decision.
//
...
func TestUnit_Interop_UniformLossesAreAggregated(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_Severities asserts the loss taxonomy is total.
//
...
func TestUnit_Interop_Severities(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_UnclassifiedLossDegrades: an unknown taxonomy key must produce a
...
func TestUnit_Interop_UnclassifiedLossDegrades(t *testing.T) {
	t.Parallel()
...
func TestUnit_Interop_ExportRefusals(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_DataSourceLosesModifiersAndDefaults: the datasource package has
// no plan modifiers and no defaults, and a blueprint carrying them must be told so
// rather than have them vanish.
func TestUnit_Interop_DataSourceLosesModifiersAndDefaults(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_DropIsCountedNotSilent: an attribute the blueprint asked to be
...
func TestUnit_Interop_DropIsCountedNotSilent(t *testing.T) {
	t.Parallel()
...
func TestUnit_Interop_ReportRendering(t *testing.T) {
	t.Parallel()
...
func TestUnit_Interop_SeverityRank(t *testing.T) {
	t.Parallel()
...
func TestUnit_Interop_PointerHelpers(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_NestedSDKTypeCrosses: associated_external_type is the one
...
func TestUnit_Interop_NestedSDKTypeCrosses(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_SingleNestedCarriesItsAttributes guards the one upstream
...
func TestUnit_Interop_SingleNestedCarriesItsAttributes(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_ResourcesAreSortedByExportedName: LoadDir sorts by blueprint
...
// across files.
func TestUnit_Interop_ResourcesAreSortedByExportedName(t *testing.T) {
	t.Parallel()
