...
// TestUnit_Interop_Version pins the version string.
//
...
func TestUnit_Interop_Version(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_Bytes covers byte-stability and the pointer discipline.
//
...
// nobody reads.
func TestUnit_Interop_Bytes(t *testing.T) {
	t.Parallel()
...
// TestUnit_Interop_MarshalEscaping: descriptions carry angle brackets and
...
func TestUnit_Interop_MarshalEscaping(t *testing.T) {
	t.Parallel()
...
func TestUnit_Interop_ParseRejectsBadInput(t *testing.T) {
	t.Parallel()
